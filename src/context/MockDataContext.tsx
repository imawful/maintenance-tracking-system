...
const generateMockRecords = (equipment) => {
...
interface MockDataContextType {
  equipment: Equipment[];
  maintenanceRecords: MintenanceRecord[];
}
...
export const MockDataProvider : React.FC<MockDataProvider> = ({children}) => {
  ...
  return(
    <MockDataContext.Provider value={{ equipment: mockEquipment, maintenanceRecords: mockRecords}}>
      {children}
